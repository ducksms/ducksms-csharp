...
namespace Org.Ducksms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorException :  IEquatable<ErrorException>, IValidatableObject
    {
        /// <summary>
        ...
        public ErrorException(int status = default(int), string message = default(string))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as ErrorException);
        }

        /// <summary>
        /// Returns true if ErrorException instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorException input)
        {
            if (input == null)
                return false;
