...
namespace Org.Ducksms.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditBalance :  IEquatable<CreditBalance>, IValidatableObject
    {
        /// <summary>
        ...
        public CreditBalance(int status = default(int), string message = default(string), Dictionary<string, List<int>> data = default(Dictionary<string, List<int>>))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as CreditBalance);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreditBalance input)
        {
            if (input == null)
                return false;
