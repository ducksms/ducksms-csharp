...
${nuget_cmd} install src/Org.Ducksms/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Org.Ducksms.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Org.Ducksms.dll \
-recurse:'src/Org.Ducksms/*.cs' \
-doc:bin/Org.Ducksms.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Org.Ducksms.dll was created successfully"
fi
